...
def main():
    ...
    for i in range(1):
        ...
        if i % 10 == 0:
            np.save('figure1/det_14w_l2_train.npy', train)
            np.save('figure1/det_14w_l2_eig.npy', eig)
            np.save('figure1/det_14w_l2_pearson.npy', pearson)
            np.save('figure1/det_14w_l2_spearman.npy', spearman)
    np.save('figure1/det_14w_l2_train.npy', train)
    np.save('figure1/det_14w_l2_eig.npy', eig)
    np.save('figure1/det_14w_l2_pearson.npy', pearson)
    np.save('figure1/det_14w_l2_spearman.npy', spearman)
