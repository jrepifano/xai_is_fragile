...
def main():
    ...
    for i in range(50):
        ...
        if i % 10 == 0:
            np.save('figure1/det_5l_train.npy', train)
            np.save('figure1/det_5l_eig.npy', eig)
            np.save('figure1/det_5l_pearson.npy', pearson)
            np.save('figure1/det_5l_spearman.npy', spearman)
    np.save('figure1/det_5l_train.npy', train)
    np.save('figure1/det_5l_eig.npy', eig)
    np.save('figure1/det_5l_pearson.npy', pearson)
    np.save('figure1/det_5l_spearman.npy', spearman)
