...
from vgg13_cifar import vgg13, train, finetune, get_influence
...
def main():
    ...
    for i in range(50):
        ...
        # break
        np.save('est_loss_diffs_max_vgg.npy', est_loss_diffs, allow_pickle=True)
        np.save('true_loss_diffs_max_vgg.npy', true_loss_diffs, allow_pickle=True)
        print('{}/{}'.format(i, 50))
