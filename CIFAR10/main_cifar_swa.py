...
from lenet_cifar_swa import lenet, train, finetune, get_influence
...
def main():
    ...
    for i in range(50):
        ...
        # break
        np.save('est_loss_diffs_med_lenet.npy', est_loss_diffs, allow_pickle=True)
        np.save('true_loss_diffs_med_lenet.npy', true_loss_diffs, allow_pickle=True)
        print('{}/{}'.format(i, 50))
